...
namespace margelo::nitro::camera::facedetector {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/camera/facedetector/Func_void;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/camera/facedetector/Func_void_cxx;";
