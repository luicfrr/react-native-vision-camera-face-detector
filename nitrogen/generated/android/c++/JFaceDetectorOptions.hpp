...
namespace margelo::nitro::camera::facedetector {
  ...
  public:
    ...
    static jni::local_ref<JFaceDetectorOptions::javaobject> fromCpp(const FaceDetectorOptions& value) {
      using JSignature = JFaceDetectorOptions(jni::alias_ref<JPerformanceMode>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<JCameraPosition>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JDouble>);
      static const auto clazz = javaClassStatic();
