///
/// FaceDetectorOptionsAutoModeDisabled.swift
...
/**
 * Represents an instance of `FaceDetectorOptionsAutoModeDisabled`, backed by a C++ struct.
 */
public typealias FaceDetectorOptionsAutoModeDisabled = margelo.nitro.camera.facedetector.FaceDetectorOptionsAutoModeDisabled

public extension FaceDetectorOptionsAutoModeDisabled {
  private typealias bridge = margelo.nitro.camera.facedetector.bridge.swift

  /**
   * Create a new instance of `FaceDetectorOptionsAutoModeDisabled`.
   */
