///
/// FaceDetectorOptionsAutoModeEnabled.swift
...
/**
 * Represents an instance of `FaceDetectorOptionsAutoModeEnabled`, backed by a C++ struct.
 */
public typealias FaceDetectorOptionsAutoModeEnabled = margelo.nitro.camera.facedetector.FaceDetectorOptionsAutoModeEnabled

public extension FaceDetectorOptionsAutoModeEnabled {
  private typealias bridge = margelo.nitro.camera.facedetector.bridge.swift

  /**
   * Create a new instance of `FaceDetectorOptionsAutoModeEnabled`.
   */
  init(autoMode: Bool, windowWidth: Double, windowHeight: Double, performanceMode: PerformanceMode?, runLandmarks: Bool?, runContours: Bool?, runClassifications: Bool?, minFaceSize: Double?, trackingEnabled: Bool?, cameraFacing: CameraPosition?) {
    self.init(autoMode, windowWidth, windowHeight, { () -> bridge.std__optional_PerformanceMode_ in
