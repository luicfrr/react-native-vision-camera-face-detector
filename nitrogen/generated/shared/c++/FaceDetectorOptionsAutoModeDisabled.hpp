///
/// FaceDetectorOptionsAutoModeDisabled.hpp
...
namespace margelo::nitro::camera::facedetector {
  ...
  /**
   * A struct which can be represented as a JavaScript object (FaceDetectorOptionsAutoModeDisabled).
   */
  struct FaceDetectorOptionsAutoModeDisabled final {
  public:
  ...
  public:
    FaceDetectorOptionsAutoModeDisabled() = default;
    explicit FaceDetectorOptionsAutoModeDisabled(std::optional<bool> autoMode, std::optional<double> windowWidth, std::optional<double> windowHeight, std::optional<PerformanceMode> performanceMode, std::optional<bool> runLandmarks, std::optional<bool> runContours, std::optional<bool> runClassifications, std::optional<double> minFaceSize, std::optional<bool> trackingEnabled, std::optional<CameraPosition> cameraFacing): autoMode(autoMode), windowWidth(windowWidth), windowHeight(windowHeight), performanceMode(performanceMode), runLandmarks(runLandmarks), runContours(runContours), runClassifications(runClassifications), minFaceSize(minFaceSize), trackingEnabled(trackingEnabled), cameraFacing(cameraFacing) {}

  public:
    friend bool operator==(const FaceDetectorOptionsAutoModeDisabled& lhs, const FaceDetectorOptionsAutoModeDisabled& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ FaceDetectorOptionsAutoModeDisabled <> JS FaceDetectorOptionsAutoModeDisabled (object)
  template <>
  struct JSIConverter<margelo::nitro::camera::facedetector::FaceDetectorOptionsAutoModeDisabled> final {
    static inline margelo::nitro::camera::facedetector::FaceDetectorOptionsAutoModeDisabled fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::camera::facedetector::FaceDetectorOptionsAutoModeDisabled(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::camera::facedetector::FaceDetectorOptionsAutoModeDisabled& arg) {
