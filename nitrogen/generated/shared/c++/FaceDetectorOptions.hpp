...
namespace margelo::nitro::camera::facedetector {
  ...
  public:
    ...
    explicit FaceDetectorOptions(std::optional<PerformanceMode> performanceMode, std::optional<bool> runLandmarks, std::optional<bool> runContours, std::optional<bool> runClassifications, std::optional<double> minFaceSize, std::optional<bool> trackingEnabled, std::optional<CameraPosition> cameraFacing, std::optional<bool> autoMode, std::optional<double> windowWidth, std::optional<double> windowHeight): performanceMode(performanceMode), runLandmarks(runLandmarks), runContours(runContours), runClassifications(runClassifications), minFaceSize(minFaceSize), trackingEnabled(trackingEnabled), cameraFacing(cameraFacing), autoMode(autoMode), windowWidth(windowWidth), windowHeight(windowHeight) {}
...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::camera::facedetector::FaceDetectorOptions> final {
    static inline margelo::nitro::camera::facedetector::FaceDetectorOptions fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::camera::facedetector::FaceDetectorOptions(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::camera::facedetector::FaceDetectorOptions& arg) {
